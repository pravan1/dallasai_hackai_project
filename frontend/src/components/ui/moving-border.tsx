    ...
    >
      ...
      >
        <MovingBorder duration={duration} rx="30%" ry="30%">
          <div
            className={cn(
              'h-12 w-12 bg-[radial-gradient(#60a5fa_40%,transparent_60%)] opacity-80',
              borderClassName,
            )}
          />
        </MovingBorder>
      ...
      <div
        className={cn(
          'relative flex h-full w-full items-center justify-center border border-border bg-card/90 text-foreground antialiased backdrop-blur-xl',
          className,
        )}
        style={{ borderRadius: `calc(${borderRadius} * 0.96)` }}
      >
